    ...
    return function(e, n) {
        ...
        function h(t) {
            return l(t), r({
                ...
                autoHide: !0,
                addMessage: !0
            }, t), x.action.type = t.type, x.action.cssClass = t.cssClass, x.action.autoHide = t.autoHide, x.action.addMessage = t.addMessage, new Promise(function(e, n) {
        ...
        var y = {
            ...
            methods: {
                handle_action_button: function(t) {
                    ...
                    for (var o in t) t.hasOwnProperty(o) && "type" !== o && "text" !== o && "value" !== o && (n[o] = t[o]);
                    v(n)
                },
        ...
        return m.message = {
            ...
            update: function(t, e) {
                var n = x.messages[t];
                return n.content = e.content,n.cssClass = e.cssClass, n.visible = !e.loading, n.loading = !!e.loading, Promise.resolve(e.content)
            },
            removeAll: function() {
            ...
            select: function(t) {
                if (l(t), t.type = "select", t.action.label = t.action.label || "text", t.action.value = t.action.value || "", t.action.searchselect = void 0 !== t.action.searchselect ? t.action.searchselect : p.searchselect, t.action.multipleselect = t.action.multipleselect || !1, t.action.searchselect && "string" == typeof t.action.value)
                ...
                }), x.action.button = t.action.button, x.action.select = t.action, h(t)
            },
            buttontext: function(t) {
                return l(t), t.type = "buttontext", x.action.button.buttons = t.actionButton, x.action.text = t.actionText, h(t)
            }
